...
# 頂部 TWS Logo 與 標題
# 你可以將下方的圖片網址換成 TWS 官方 Logo 的直接連結
...
with col_title:
    st.title("韓語筆記")
    st.caption("24/7 With Us! 宜真的專屬學習空間 💙")
...
if not df.empty:
    ...
    st.divider()
    st.markdown(f"[🔗 打開試算表]({url if 'url' in locals() else 'https://docs.google.com/spreadsheets/d/1dcEYmAqIYng4YFFAT98Uxy_NXskGQaAAidCzzORuJag/edit'})")
